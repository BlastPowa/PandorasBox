...
export function DiscoveryPageHeader({ eyebrow = "PBox Discovery", title, description, actions }: { eyebrow?: string; title: string; description: string; actions?: ReactNode }) {
  return (
    <header className="relative overflow-hidden rounded-[var(--radius-xl)] border border-[var(--media-border)] bg-[linear-gradient(120deg,rgb(var(--accent-rgb)/0.13),rgb(var(--accent-2-rgb)/0.06)_45%,var(--glass))] px-5 py-6 shadow-[0_18px_50px_rgba(0,0,0,0.28)] sm:px-7 sm:py-8">
